    ...
    <div className="flex items-center justify-between bg-primary/5 border border-primary/20 rounded-sm px-4 py-2">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          disabled={selectedCount === 0}
          className="flex items-center gap-1.5 text-[9px] font-bold uppercase tracking-widest bg-background border border-border/50 text-destructive px-3 py-1.5 rounded-sm hover:bg-destructive hover:text-destructive-foreground transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
