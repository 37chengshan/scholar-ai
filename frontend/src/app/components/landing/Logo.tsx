    ...
    <div className="flex items-center gap-3">
      <div className="relative shrink-0" style={{ width: 40, height: 40 }}>
        ...
        >
          ...
          {/* S in left ring */}
          <text x="30" y="50" textAnchor="middle" fontFamily="Outfit, sans-serif" fontSize="16" fontWeight="600" className="fill-foreground">S</text>
          {/* AI in right ring */}
          <text x="60" y="50" textAnchor="middle" fontFamily="Outfit, sans-serif" fontSize="14" fontWeight="600" className="fill-primary">AI</text>
          {/* Small dots at intersection */}
