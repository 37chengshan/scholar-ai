    ...
    <div className={`flex items-center gap-3 ${className}`.trim()}>
      <div className="relative shrink-0" style={{ width: markSize, height: markSize }}>
        ...
        >
          ...
          <text x="30" y="50" textAnchor="middle" fontFamily="Playfair Display, Noto Serif SC, serif" fontSize="16" fontWeight="600" className="fill-foreground">S</text>
          <text x="60" y="50" textAnchor="middle" fontFamily="Outfit, sans-serif" fontSize="13" fontWeight="700" className="fill-primary">AI</text>
      ...
      {!hideText ? (
        <span
          ...
          style={{ fontFamily: "'Playfair Display', 'Noto Serif SC', serif", fontStyle: "italic" }}
        >
          ScholarAI
        </span>
      ) : null}
