/**
 * MarkdownRendererInner - heavy rendering internals
 *
 * This module is dynamically imported by MarkdownRenderer.tsx to keep
 * react-markdown, katex, highlight.js, and mermaid out of the main bundle.
 */
...
export function MarkdownRendererInner({ content, className }: MarkdownRendererInnerProps) {
  return (
    <div className={clsx(
