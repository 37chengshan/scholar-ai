...
export function ArtifactsDrawer() {
  ...
  return (
    <aside className="fixed right-[320px] top-14 z-40 h-[calc(100vh-3.5rem)] w-[320px] border-l border-border bg-surface p-4 shadow-lg">
      ...
      <div className="mt-4 space-y-3">
        {artifacts.length === 0 ? (
          <p className="text-xs text-zinc-500">{isZh ? '当前范围内没有可用产物。' : 'No artifacts available in this scope.'}</p>
        ) : (
