    ...
    >
      ...
      <div className="flex-1 flex flex-col min-h-0 bg-muted/10">
        <div className="p-5 border-b border-border/50">
          <h3 className="text-[9px] font-bold tracking-[0.3em] uppercase text-muted-foreground mb-3 flex items-center gap-1.5 font-serif tracking-tight">
        ...
        <div className="flex-1 flex flex-col p-4 bg-[#1e1e1e] text-[#a9b7c6] overflow-hidden">
          <h3 className="text-[9px] font-bold tracking-[0.3em] uppercase text-[#6a8759] mb-3 pb-2 border-b border-[#3c3f41] font-serif tracking-tight">{streamLabel}</h3>
        ...
        <div className="p-4 border-t border-border/50">
          <div className="text-[9px] font-bold tracking-[0.2em] uppercase text-muted-foreground flex items-center gap-1.5">
            <Activity className="w-3.5 h-3.5" /> 后台监测
          </div>
        </div>
      </div>
    </motion.div>
