  ...
  return (
    <div className="h-full flex font-sans bg-background text-foreground">
      ...
      <motion.div
        ...
        className="w-[252px] border-r border-zinc-200 flex flex-col h-full bg-zinc-50/70"
      >
        <div className="px-4 py-3 border-b border-zinc-200 flex items-center justify-between bg-zinc-50/90">
          <div>
            <h2 className="font-serif text-base font-bold tracking-tight">{t.terminal}</h2>
            <p className="text-[10px] tracking-[0.14em] uppercase text-zinc-500">{t.sessions}</p>
          </div>
          <button
