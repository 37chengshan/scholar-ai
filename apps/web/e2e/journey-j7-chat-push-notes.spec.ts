...
test.describe('J7: Chat -> Push to Notes', () => {
  test('J7: push chat message to notes', async ({ page }) => {
    ...
    test.skip(true, 'Chat-Notes bridge API not implemented (j7_bridge_available=false)');
  });
});
