...
- Merge `doc/` into `docs/`.
- Route imported API/vendor notes into `docs/specs/reference/`.
- Route reports into `docs/plans/<version>/reports/` when version is known, otherwise archive them under `docs/plans/archive/reports/`.
...
- Add `docs/specs/architecture/system-overview.md`.
- Add `docs/specs/architecture/api-contract.md`.
- Add `docs/specs/architecture/resources.md`.
- Add `docs/specs/engineering/coding-standards.md`.
- Add `docs/specs/engineering/pr-process.md`.
