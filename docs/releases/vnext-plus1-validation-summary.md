...
- 矩阵文件：`docs/qa/validation-matrix-vnext-plus1.md`
- 结果文件：`docs/qa/validation-results/2026-04-vnext-plus1.md`
...
关键指标口径见：`docs/qa/metrics-spec-vnext-plus1.md`

## RAG 评测摘要

- 数据集：`tests/evals/rag_eval_dataset.json`（32 条）
- 规范：`docs/qa/rag-eval-spec.md`
