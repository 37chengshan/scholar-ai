...
- 新增治理规则：同步更新 docs/development/coding-standards.md 与 scripts/check-*.sh。
- 新增校验门禁：同步更新 .github/workflows/governance-baseline.yml。
- 调整文档骨架：同步更新 docs/development/documentation-validation.md。
- 调整架构边界：同步更新 docs/architecture/system-overview.md 与 AGENTS.md。
