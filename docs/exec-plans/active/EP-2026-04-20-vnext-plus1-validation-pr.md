...
计划改动：
1. 新增 `docs/qa/validation-matrix-vnext-plus1.md`
   - 至少 12 场景：
...
2. 新增 `docs/qa/validation-results/2026-04-vnext-plus1.md`
   - 结构化结果表（可人工/自动填充）
...
2. 新增 `docs/qa/metrics-spec-vnext-plus1.md`
   - 口径冻结：
...
1. docs/qa/validation-matrix-vnext-plus1.md
2. docs/qa/validation-results/2026-04-vnext-plus1.md
3. scripts/verify/run-validation-matrix.sh
4. scripts/verify/summarize_validation_results.py
5. docs/qa/metrics-spec-vnext-plus1.md

PR-C（rag-eval-baseline）：
1. tests/evals/rag_eval_dataset.json
2. scripts/evals/run_rag_eval.py
3. docs/qa/rag-eval-spec.md
4. docs/releases/vnext-plus1-validation-summary.md
...
6. `docs/qa/validation-matrix-vnext-plus1.md`
7. `docs/qa/validation-results/2026-04-vnext-plus1.md`
8. `docs/qa/metrics-spec-vnext-plus1.md`
9. `docs/qa/rag-eval-spec.md`
10. `tests/evals/rag_eval_dataset.json`
11. `scripts/evals/run_rag_eval.py`
12. `docs/releases/vnext-plus1-validation-summary.md`
