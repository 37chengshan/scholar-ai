...
| 5 | web-platform | research-complete / execution-plan-required | 2026-05-11 | docs/plans/v4_0/active/phase_5/2026-05-11_v4_0_phase_5_frontend_interaction_quality_research.md | 前端打磨 phase 2：Frontend Interaction Quality 研究已完成，下一步应冻结执行顺序、主链页面清单与 walkthrough/test gate |
| 6 | ai-runtime | research-complete / execution-plan-required | 2026-05-11 | docs/plans/v4_0/active/phase_6/2026-05-11_v4_0_phase_6_academic_rag_optimization_research.md | B 优化 phase：Academic RAG Optimization 研究已完成；冻结为主链 extend、综述支线 experiment、评测层 adopt、第二套 runtime reject |
