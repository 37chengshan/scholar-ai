...
| 2 | product-engineering | research-started / plan-required | 2026-05-03 | docs/plans/v4_0/active/phase_2/2026-05-03_v4_0_phase_2_beta_release_hardening_research.md | C 主线：Beta Release Hardening；研究结论限定为 controlled beta hardening，先补 Beta assets 与 fresh-state walkthrough，不宣称 public beta 或 release-pass |
...
| v4_0_phase_2_beta_release_hardening_research | product-engineering | in-progress | 20_v4_0_phase_1_execution_plan,19_v4_0_phase_0_execution_plan | 2026-05-03 | working-tree-v4-0-phase-2-research | V4.0-2 | DU-20260503-001 | pending | docs/plans | high | Phase 4.0-2 研究已启动：controlled beta hardening，定义 demo dataset/account、quickstart、known limitations、feedback loop、fresh-state walkthrough 和 controlled beta gate；执行计划待后续生成 |
