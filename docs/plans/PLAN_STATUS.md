...
| v4_0_phase_2_beta_release_hardening_research | product-engineering | done | 20_v4_0_phase_1_execution_plan,19_v4_0_phase_0_execution_plan | 2026-05-08 | PR70 | V4.0-2 | DU-20260503-001 | merged: https://github.com/37chengshan/scholar-ai/pull/70 | docs/plans | high | Phase 4.0-2 研究已完成：controlled beta hardening，定义 demo dataset/account、quickstart、known limitations、feedback loop、fresh-state walkthrough 和 controlled beta gate |
| 21_v4_0_phase_2_execution_plan | product-engineering | done | v4_0_phase_2_beta_release_hardening_research,20_v4_0_phase_1_execution_plan | 2026-05-08 | PR70,PR71,990e14ab | V4.0-2 | DU-20260503-002 | pending | docs/plans,apps/api,apps/web | high | Phase 4.0-2 先在 2026-05-04 取得 `walkthrough-complete / demo-ready`，后续 2026-05-08 补齐 controlled release gate：feedback queue、access policy 与 rollback/pause 规则已进入 repo truth；当前结论升级为 `closeout-complete / controlled-beta-ready`，但仅限 local controlled beta |
