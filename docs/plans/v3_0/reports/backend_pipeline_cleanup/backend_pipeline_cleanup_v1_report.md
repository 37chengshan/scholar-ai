...
| `docs/specs/contracts/file_metadata_contract.md` | storage_key format + propagation rules |
| `docs/specs/contracts/import_processing_state_machine.md` | State machine diagrams + invariants |
| `docs/plans/v3_0/reports/backend_pipeline_cleanup/upload_entry_audit.md` | 15-endpoint audit table |
