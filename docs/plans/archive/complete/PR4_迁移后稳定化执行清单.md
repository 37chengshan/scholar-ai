...
- `docs/specs/governance/migration-conditions.md` 仍偏“迁移前置条件/迁移准入”视角，缺少“迁移后稳定期”操作说明。
...
1. 新增 `docs/plans/archive/reports/post-migration-stabilization-checklist.md`，作为 PR-4 交付报告模板。
...
- `docs/specs/governance/migration-conditions.md` 改为“迁移完成后的稳定化守则 + 退出条件”
- `docs/specs/development/testing-strategy.md` 增加“不要提交测试产物 / coverage / 本地 venv”规则
- 新增 `docs/plans/archive/reports/post-migration-stabilization-checklist.md`
...
3. `docs/plans/archive/reports/post-migration-stabilization-checklist.md`
   - 记录本次 PR-4 的清理范围
   - 记录本地验证结果
   - 记录 CI 结果
   - 记录残留风险（如不清理的目录）
...
15. `docs/specs/governance/migration-conditions.md`
   - 从“迁移准入条件”更新为两部分：
     - 迁移已完成的前提
     - 迁移后稳定期的持续门禁
   - 保留历史背景，但新增“Do not reintroduce legacy paths”与“Do not commit local environments / reports”

16. `docs/specs/development/testing-strategy.md`
   - 新增“测试产物不入库”规则：
     - `test-results/`
     - `playwright-report/`
     - `.coverage`
...
17. `docs/specs/governance/code-boundary-baseline.md`
   - 增加一条仓库 hygiene 约束说明：
...
1. 修改 `README.md`
2. 修改 `AGENTS.md`
3. 修改 `docs/specs/governance/migration-conditions.md`
4. 修改 `docs/specs/development/testing-strategy.md`
5. 修改 `docs/specs/governance/code-boundary-baseline.md`
6. 新增 `docs/plans/archive/reports/post-migration-stabilization-checklist.md`
