...
```bash
cat docs/plans/archive/reports/v3_6_release_gate_report.md
```
...
```txt
docs/specs/agent/01_agent_framework_index.md
docs/plans/archive/reports/audits/02_backend_full_audit.md
docs/plans/archive/reports/audits/03_frontend_multidimensional_audit.md
docs/plans/archive/complete/04_phase0_execution_plan.md
docs/plans/archive/complete/05_phase1_execution_plan.md
```
...
2. docs/plans/archive/reports/v3_6_release_gate_report.md 与源码一致。
